        ...
        <div className="row g-4">
          <div className="col-lg-4 col-md-6 mb-4 mb-lg-0">
            <h5 className="mb-3 d-flex align-items-center">
              <span className="me-2 fs-4">🏫</span> School System
            </h5>
            <p className="text-white-50 mb-3">
              Excellence in education since day one. Empowering students through quality 
              education and dedicated teachers.
            </p>
            <div className="d-flex gap-3">
              <a href="#" className="text-white-50 text-decoration-none" aria-label="Facebook">
              ...
              <a href="#" className="text-white-50 text-decoration-none" aria-label="Instagram">
                <svg width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="col-lg-2 col-md-6 mb-4 mb-lg-0">
            ...
            <ul className="list-unstyled">
              ...
              <li className="mb-2">
                <Link to="/teachers" className="text-white-50 text-decoration-none">Our Teachers</Link>
              </li>
              <li className="mb-2">
          ...
          <div className="col-lg-3 col-md-6 mb-4 mb-lg-0">
            ...
            <p className="mb-2 text-white-50 d-flex align-items-start">
              <span className="me-2">📧</span>
              <span>info@schoolsystem.com</span>
            </p>
            <p className="mb-2 text-white-50 d-flex align-items-start">
              <span className="me-2">📞</span>
              <span>+1 (555) 123-4567</span>
            </p>
            <p className="mb-0 text-white-50 d-flex align-items-start">
              <span className="me-2">📍</span>
